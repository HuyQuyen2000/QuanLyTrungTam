...
class _CalendarState extends State<Calendar> {
  ...
  loadDates() async {
    ...
    for(int i = 0; i < _dates.length; i++){
      ...
      // String title = _dates[i]['room']['time_start'].toString() + '-' +_dates[i]['room']['time_end'].toString() + '    ' + _dates[i]['room']['room_name'].toString();
            ...
            Container(
              decoration: BoxDecoration(
                ...
                // ),
                  ...
                  border: Border.all(width: 1.8, color:Colors.greenAccent.shade400),
