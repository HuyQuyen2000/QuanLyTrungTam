...
class TeacherPosts2Screen extends StatefulWidget{
  var roomID;
  TeacherPosts2Screen({Key? key, @required this.roomID}) : super(key: key);

  @override
  State<TeacherPosts2Screen> createState() => _TeacherPosts2ScreenState(roomID);
}

class _TeacherPosts2ScreenState extends State<TeacherPosts2Screen>{
  final roomID;
  _TeacherPosts2ScreenState(this.roomID);
  String _email = '';
  String _password = '';
  String _type = '1';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          Visibility(
                            ...
                            child: Column(
                              children: [
                                Icon(Icons.home_work, size: 30, color: Colors.green),
                                SizedBox(
                                  height: 20,
                                )
                              ],
