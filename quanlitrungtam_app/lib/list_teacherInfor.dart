...
class TeacherListIScreen extends StatefulWidget{
  var roomID;
  TeacherListIScreen({Key? key, @required this.roomID}) : super(key: key);

  @override
  State<TeacherListIScreen> createState() => _TeacherListIScreenState(roomID);
}

class _TeacherListIScreenState extends State<TeacherListIScreen>{
  final roomID;
  _TeacherListIScreenState(this.roomID);
  String _email = '';
  String _password = '';
  String _type = '1';
