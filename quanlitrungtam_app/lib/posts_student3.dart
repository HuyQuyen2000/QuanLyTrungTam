...
class StudentPosts3Screen extends StatefulWidget{
  var roomID;
  StudentPosts3Screen({Key? key, @required this.roomID}) : super(key: key);

  @override
  State<StudentPosts3Screen> createState() => _StudentPosts3ScreenState(roomID);
}

class _StudentPosts3ScreenState extends State<StudentPosts3Screen>{
  final roomID;
  _StudentPosts3ScreenState(this.roomID);
  String _email = '';
  String _password = '';
  String _type = '1';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          Visibility(
                            ...
                            child: Column(
                              children: [
                                Icon(Icons.book, size: 30, color: Colors.orange),
                                SizedBox(
                                  height: 20,
                                )
                              ],
