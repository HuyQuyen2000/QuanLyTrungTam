...
import 'package:quanlitrungtam_app/post_postNew2.dart';
import 'package:quanlitrungtam_app/post_post2.dart';
import 'package:quanlitrungtam_app/post_file2.dart';
import 'package:quanlitrungtam_app/post_task2.dart';
...
class StudentPosts2Screen extends StatefulWidget{
  var roomID;
  StudentPosts2Screen({Key? key, @required this.roomID}) : super(key: key);

  @override
  State<StudentPosts2Screen> createState() => _StudentPosts2ScreenState(roomID);
}

class _StudentPosts2ScreenState extends State<StudentPosts2Screen>{
  final roomID;
  _StudentPosts2ScreenState(this.roomID);
  String _email = '';
  String _password = '';
  String _type = '1';
  ...
  loadPostList() async {
    ...
    await http
        .get(Uri.parse('http://10.0.2.2:8000/api/post2list' + params.toString()))
        .then((response){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          if(_posts[index]['post_type'].toString() == '1'){
                            ...
                            context,
                            MaterialPageRoute(
                                builder: (context) => PostScreen2(postID: _posts[index]['post_id'])),
                          ).then((value) {
                              loadPostList();
                            });
                          };
                          if(_posts[index]['post_type'].toString() == '2'){
                            ...
                            context,
                            MaterialPageRoute(
                                builder: (context) => PostFile2Screen(postID: _posts[index]['post_id'])),
                          ).then((value) {
                              loadPostList();
                            });
                          };
                          if(_posts[index]['post_type'].toString() == '3'){
                            ...
                            context,
                            MaterialPageRoute(
                                builder: (context) => PostTask2Screen(postID: _posts[index]['post_id'])),
                          ).then((value) {
                              loadPostList();
                            });
                          };
                      ...
                      child: Padding(
                        ...
                        child: Column(
                                  ...
                                  children: [
                                   Container(
                                      ...
                                      Column(
                                        ...
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        children: [
                                          Text('Tài liệu ' + (_posts.length - index).toString(), style: TextStyle(fontSize: 21, fontWeight: FontWeight.bold)),
                          ...
                          Visibility(
                            ...
                            child: Column(
                              children: [
                                Icon(Icons.home_work, size: 30, color: Colors.orange),
                                SizedBox(
                                  height: 20,
                                )
                              ],
          ...
          //           context,
          //           MaterialPageRoute(
          //             builder: (context) => NewPostScreen2(roomID: roomID.toString())),
