...
class NewPostFileScreen extends StatefulWidget{
  var roomID;
  NewPostFileScreen({Key? key, @required this.roomID}) : super(key: key);

  @override
  State<NewPostFileScreen> createState() => _NewPostFileScreenState(roomID);
}

class _NewPostFileScreenState extends State<NewPostFileScreen>{
  final roomID;
  _NewPostFileScreenState(this.roomID);
 ...
 upload() async {
  final storage = new FlutterSecureStorage();
    ...
    if (_paths == null) {
      ...
      String url = 'http://10.0.2.2:8000/api/file_uploadTeacher'; // change it with your api url
        ...
        padding: const EdgeInsets.symmetric(horizontal: 10),
          child: Column(
              ...
              children: [
                ...
                Text('Nhập ghi chú cho tài liệu', style: TextStyle(fontSize: 23, fontWeight: FontWeight.bold)),
                const SizedBox(
                  height: 30,
                ),
                    TextField(
                ...
                const SizedBox(
                  ...
                  MaterialButton(
                    child: Text('ĐĂNG TẢI TÀI LIỆU', style: TextStyle(fontSize: 20)),
