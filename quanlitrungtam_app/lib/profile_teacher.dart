...
class TeacherInforScreen extends StatefulWidget{
  const TeacherInforScreen({Key? key}) : super(key: key);

  @override
  State<TeacherInforScreen> createState() => _TeacherInforScreenState();
}

class _TeacherInforScreenState extends State<TeacherInforScreen>{
  String _email = '';
  String _password = '';
  String _name = '';
  String _phone = '';
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            children: [
              ...
              Text('Thông tin tài khoản', style: TextStyle(color: Colors.green, fontSize: 25, fontWeight: FontWeight.bold)),
              SizedBox(
                height: 40,
              ),
