...
class PostFile2Screen extends StatefulWidget{
  var postID;
  PostFile2Screen({Key? key, @required this.postID}) : super(key: key);

  @override
  State<PostFile2Screen> createState() => _PostFile2ScreenState(postID);
}

class _PostFile2ScreenState extends State<PostFile2Screen>{
  final postID;
  _PostFile2ScreenState(this.postID);
