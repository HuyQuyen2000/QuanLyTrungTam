...
import 'package:quanlitrungtam_app/rooms_teacher.dart';
import 'package:quanlitrungtam_app/profile_teacher.dart';
import 'package:quanlitrungtam_app/calender.dart';
import 'package:quanlitrungtam_app/home_teacherb.dart';
...
import 'package:quanlitrungtam_app/calendar_ex.dart';

class TeacherMenuScreen extends StatefulWidget{
  const TeacherMenuScreen({Key? key}) : super(key: key);

  @override
  State<TeacherMenuScreen> createState() => _TeacherMenuScreenState();
}
        ...
        children: [
          DrawerHeader(
            ...
            child: Column(
              ...
              children: [
                Text('Tài khoản giáo viên', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
          ...
          // ListTile(
          //   leading: Icon(
          //     Icons.edit_document, size: 30
          //   ),
          //   title: const Text('Ví dụ', style: TextStyle(fontSize: 25)),
          //   onTap: () {
          //     page.jumpToPage(3);
          //     Navigator.pop(context);
          //   },
            ...
            child: PageView(
              ...
              children: [
                ...
                Container(
                  color: Colors.white,
                  child: const Center(
                    child: TeacherInforScreen(),
                  ),
                ),
                // Container(
                //   color: Colors.white,
                //   child: const Center(
                //     child: TeacherMenubScreen(),
                //   ),
                // ),
