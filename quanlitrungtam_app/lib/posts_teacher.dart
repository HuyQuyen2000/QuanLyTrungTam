...
class TeacherPostsScreen extends StatefulWidget{
  var roomID;
  TeacherPostsScreen({Key? key, @required this.roomID}) : super(key: key);

  @override
  State<TeacherPostsScreen> createState() => _TeacherPostsScreenState(roomID);
}

class _TeacherPostsScreenState extends State<TeacherPostsScreen>{
  final roomID;
  _TeacherPostsScreenState(this.roomID);
  String _email = '';
  String _password = '';
  String _type = '1';
                    ...
                    return FractionallySizedBox(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                          Text(_posts[index]['teacher']['name'], style: TextStyle(fontSize: 21, fontWeight: FontWeight.bold)),
